...
export default function SubContactForm({ contactId, setSubContactRefresh }) {
  ...
  return (
    <div>
      <ToastContainer />
      <Form.Group as={Row} >
        <Form.Label style={{"marginLeft":'-4px'}} column sm={3}> Sub Contact </Form.Label>
        <Col xs={6} className="subContactFormCol">
          <Button style={{ "marginLeft": "-0.3rem" }} variant="primary outlined" onClick={handleShow}>
