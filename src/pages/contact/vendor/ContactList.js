...
const App = props => {
    ...
    const getTemplateName = async () => {
        ...
        //  console.log(templates.results[0].name)
            ...
            <Card.Body>
                <div className="ag-theme-alpine" style={{ height: "100%" }}>
                    ...
                    <div style={{ display: 'flex', position: 'relative' }}>
                        ...
                        >
                            Import </Button>
                        <EmailTemplateModal show={modalShow} rowSelectedData={rowSelectedData} onHide={() => setModalShow(false)} countRows={countRows} getTemplateData={getTemplateData} emailTemplateVariablesNames={emailTemplateVariablesNames} getTemplateName={getTemplateName}/>
                        {/* //Send Email Button */}
                        {/* <EmailTemplateModal show={modalShow} onHide={() => setModalShow(false)} countRows = {countRows} emailTemplateVariablesNames ={emailTemplateVariablesNames} getTemplateData={getTemplateData} rowSelectedData={rowSelectedData} getTemplateName={getTemplateName}/> */}
