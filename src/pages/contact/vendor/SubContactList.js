                    ...
                    <Form as={Row} className="justify-content-md-center">
                        ...
                        <Col xs={6}>
                            <Form.Group className="mb-1" controlId="firstName">
                                <Form.Label className="subContactFormCol">First Name</Form.Label>
                                <Form.Control
                            ...
                            <Form.Group className="mb-1" controlId="lastName">
                                <Form.Label className="subContactFormCol">Last Name</Form.Label>
                                <Form.Control
                                    readOnly={defaultSwitch}
                                    name="last_name"
                                    plaintext={defaultSwitch}
                            ...
                            <Form.Group className="mb-1" controlId="email">
                                <Form.Group as={Row}>
                                    <Form.Label className="subContactFormCol">Email</Form.Label>
                                    <Col sm={4}>
                                        <Form.Control
                                            required
                                            readOnly={defaultSwitch}
                        ...
                        <Col xs={6}>
                            <Form.Group className="mb-1" controlId="phoneNumber">
                                <Form.Label className="subContactFormCol">Phone Number</Form.Label>
                                {
                                    defaultSwitch ?
                                        <Form.Group as={Row}>
                                            <Col sm={6}>
                            ...
                            <Form.Group className="mb-1" controlId="Misc">
                                <Form.Label className="subContactFormCol">Misc</Form.Label>
                                <Form.Control
                                    readOnly={defaultSwitch}
                                    name="misc"
                                    plaintext={defaultSwitch}
                            ...
                            <Form.Group className="mb-1" controlId="phoneDescription">
                                <Form.Label className="subContactFormCol">Description</Form.Label>
                                <Form.Control
                                    readOnly={defaultSwitch}
                                    name="description"
                                    plaintext={defaultSwitch}
        ...
        <div>
            {
                ...
                (
                    <Form.Group as={Row} className={'subContactListColDetails'}>
                        {(subContact.type != "Email" && subContact.type != "Phone") && <Form.Label className='subContactFormCol' column sm={4} > {subContact.type}</Form.Label>}
                        {
                        ...
                        {
                            subContact.type == 'Email' && <EmailField className=""
                        ...
                        {
                            //=>
                            (subContact.type == 'Phone' || subContact.type == 'Email') && <Col style={{ "marginLeft": "-56px" }}>
                                <Form.Control
                                    readOnly={defaultSwitch}
                                    className="text-capitalize subContactFormCol"
                                    name="description"
                                    plaintext={defaultSwitch}
                                    value={subContact.description ? subContact["description"] : ''}
                                    placeholder="Description"
