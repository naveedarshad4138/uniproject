...
export const EmailTemplateModalAlert = (props) => {
    const { onHide,formData,onChange1,handleAddEmailTemplates } = props;
    const {name} = formData
                        ...
                        <Form>
                            <Row className={'m-4'}>
                                ...
                                <Col xs={12} md={12} lg={12} >
                                    <input className="form-control form-control-lg" type="text" onChange={onChange1} value={name} id="name" placeholder="Enter Name of Template" aria-label=".form-control-lg example" />
                                </Col>
                            </Row>
                        </Form>
