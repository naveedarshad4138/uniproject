        ...
        <div className='col align-self-center'>
          <div className="container newItem overflow-hidden">
            ...
            <div className="row gx-5">
              <div className="col-sm-12 col-md-6 col-lg-6">
                ...
                <div className="p-1 ">
                  <div className="input-group mb-1">
                    ...
                    <input type="text" id='calories' value={inputData.calories} onChange={formValueChange} className="form-control" placeholder="Add Calories" aria-label="calories" />
                  </div>
                </div>
              ...
              <div className="col-sm-12 col-md-6 col-lg-6">
                ...
                <div className="p-1 ">
                  <div className="input-group mb-1">
                    ...
                    <input type="text" id='price' value={inputData.price} onChange={formValueChange} className="form-control" placeholder="Add price" aria-label="price" />
                  </div>
                </div>
              ...
              {/* //Image Section */}
              <div className='col align-self-center'>
                <div className="p-1 position-relative  mb-1">
